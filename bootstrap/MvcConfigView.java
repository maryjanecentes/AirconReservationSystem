...
public class MvcConfigView extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/usermodule/css/**").addResourceLocations("/css/").setCachePeriod(31556926);
		registry.addResourceHandler("/usermodule/js/**").addResourceLocations("/js/").setCachePeriod(31556926);
		registry.addResourceHandler("/usermodule/php/**").addResourceLocations("/php/").setCachePeriod(31556926);
		registry.addResourceHandler("/usermodule/img/**").addResourceLocations("/img/").setCachePeriod(31556926);
	}
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		registry.addInterceptor(new UserModuleInterceptor()).addPathPatterns(
				"/user/*");
	}
